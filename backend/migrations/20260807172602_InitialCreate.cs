        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsagePerToolPerMonth = table.Column<int>(type: "integer", nullable: true),
                    PricePerUse = table.Column<decimal>(type: "numeric(10,4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsesGranted = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "Description", "IsActive", "Name", "PriceMonthly", "PricePerUse", "Type", "UsagePerToolPerMonth" },
                values: new object[,]
                {
                    { 1, "Her araç için ayda 3 kullanım", true, "Ücretsiz", 0m, null, 0, 3 },
                    { 2, "Tüm araçlarda ayda 10 kullanım", true, "Standart", 199m, null, 1, 10 },
                    { 3, "Tüm araçlarda ayda 25 kullanım", true, "Premium", 399m, null, 2, 25 },
                    { 4, "Kullandıkça öde", true, "Kurumsal", 0m, 15m, 3, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolUsageLogs_UserId_ToolId_UsedAt",
                table: "ToolUsageLogs",
                columns: new[] { "UserId", "ToolId", "UsedAt" });
